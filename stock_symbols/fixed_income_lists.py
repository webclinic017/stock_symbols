...
def main():
	...
	fi_list_creator = SterlingTraderListCreator()
	
	fi_writer = StockListsWriter(FI_LISTS_PATH)
	
	fi_sterling_engine = StockListEngine(fi_retriever, fi_transformer, fi_sorter, fi_list_creator, fi_writer)
	fi_sterling_engine.run()
